      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-white">Shapino store</h3>
            <p className="text-pretty text-sm leading-relaxed text-slate-400">
             We offer you the best products with excellent quality at affordable prices.
              Enjoy easy online shopping and fast delivery nationwide.
            </p>
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-white">Customer Services</h3>
        ...
        <div className="flex flex-col items-center justify-between gap-6 lg:flex-row">
          ...
          <div className="text-center text-sm text-slate-400 lg:text-right">
            <p className="leading-relaxed">
             All rights reserved. This website is owned by{" "}
              <span className="font-bold text-white">Shopino Store</span>{" "}
               © 2026
            </p>
          </div>
        </div>
      ...
      <div className="border-t border-slate-800 bg-slate-950 py-4">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <p className="text-center text-xs leading-relaxed text-slate-500">
            Shop Online with Complete Confidence | 24/7 Customer Support |  Free shipping on orders over $700 
          </p>
        </div>
      </div>
    </footer>
